  ...
  render() {
    var NavWithRoute = withRouter(props => <Nav {...props} />),
        ...
        ServicesWithProps = props =>
          <Services {...props} size={this.state.size} contactFill={this.contactFill} selectedItems={this.state.servicesSection} />,
        ContactWithProps = props =>
          <Contact {...props} size={this.state.size} servicesSelection={this.state.servicesSelection} />
