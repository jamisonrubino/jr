  ...
  "aboutSections": [
    {
      ...
      "skills": "HTML, CSS, Node, Javascript (jQuery, React, Angular1), Ruby on Rails, PHP, MongoDB, PostgreSQL, Firebase, Github, Heroku",
      "style": {
    ...
    },
    {
      ...
      "skills": "HTML, CSS, Javascript, React, Angular1, Ruby on Rails, PHP, MongoDB, PostgreSQL, Firebase, Github, Node",
      "style": {
