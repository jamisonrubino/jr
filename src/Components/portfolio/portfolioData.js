  ...
  "portfolioPieces": [
    {
      ...
      "summary": "My capstone project for Bloc’s Part-Time Web Developer bootcamp: a Ruby-on-Rails-based app that builds you the perfect playlist for your road trip.",
      "slug": "traveltracks",
      "style": {
    ...
    },
    {
      ...
      "blurbs": ["The home page shows the most recent posts of all categories.", "Each category has its own page and displays its most recent posts.", "The register form dynamically checks your username's availability, password vailidity and password matching. On submit, you are emailed an activation code you need to enter before you can post.", "I logged in!", "Once logged in, posts you authored show an edit link.", "You can edit posts you authored and create new posts with this basic posting form."],
      "summary": "My first attempt at PHP user validation and blogging. Left unfinished in 2015 and revived in 2018.",
