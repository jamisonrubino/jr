...
export default class Contact extends Component {
  ...
  handleFormSubmit = e => {
    ...
    if (
      ...
      this.setState(
        { submitted: true },
        () => (alert.innerHTML = "Success! Your message was delivered.")
      );
    } else {
      this.setState(
  ...
  render() {
    const ContactItem = props => (
              ...
              <span
                ...
                onClick={() =>
                  (document.querySelector(
                    ".contact__menu--" +
                      props.item[0].toLowerCase() +
                      " .contact__menu__item__wrapper"
      ...
      items = [
        [
          "Email",
          "jamison.rubino@gmail.com",
          "mailto: jamison.rubino@gmail.com",
          true
        ],
        [
          "LinkedIn",
      ...
      ].map((item, i) => <ContactItem item={item} index={i} key={i} />),
      ContactForm = props => (
